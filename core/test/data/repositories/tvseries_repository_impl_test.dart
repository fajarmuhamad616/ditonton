...
void main() {
  ...
  final tTvSeriesModelList = testTvSeriesModelList;
  final tTvSeriesList = testTvList;
  ...
  group('Get TvSeries Detail', () {
    final tId = 1;
    final tTvSeriesResponse = testTvSeriesDetailResponse;
  ...
  group('Get TvSeries Recommendations', () {
    final tTvSeriesList = testTvSeriesModelList;
    final tId = 1;
